...
import javax.swing.*;  
class task2 extends JFrame implements ItemListener, ActionListener
{  
...
task2()
{  
super("tic tac toe by khushi");  
CheckboxGroup cbg=new CheckboxGroup();  
c11=new Checkbox("vs computer",cbg,false);  
c22=new Checkbox("vs friend",cbg,false);  
c11.setBounds(120,80,100,40);  
c22.setBounds(120,150,100,40);  
add(c11); add(c22);  
...
else if(c22.getState())  
{ 
  type=true;  
}  
remove(c11);remove(c22);  
repaint(0,0,330,450);  
showButton();  
}
...
{   
  ...
  JOptionPane.showMessageDialog(task2.this,"!!!YOU won!!! click reset");     
  break;  
}  
else if(icon1==ic2)
{  
...
JOptionPane.showMessageDialog(task2.this,"won! click reset");  
 break;            
}         
}  
}    
